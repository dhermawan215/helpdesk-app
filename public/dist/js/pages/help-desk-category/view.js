var Index = (function () {
    ...
    var handleDataTabelUser = function () {
        table = $("#table-help-desk-category").DataTable({
            responsive: true,
            autoWidth: true,
            pageLength: 15,
            dom: "Bfrtip",
            ...
            serverSide: true,
            ajax: {
                url: url + "/help-desk-category/list",
                type: "POST",
                data: {
                    _token: csrf_token,
                },
        ...
        $("#table-help-desk-category tbody").on("click", "tr", function () {
        ...
        $("#btn-delete").click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: url + "/help-desk-category/delete",
                        data: {
                            _token: csrf_token,
                            dValue: aSelected,
                        },
    ...
    var handleEdit = function (value) {
        $(document).on("click", ".btn-edit", function () {
            ...
            $("#edit-category-name").val(value.name);
    ...
    var handleUpdate = function (handleEdit) {
        $("#form-edit-category").submit(function (e) {
            ...
            $.ajax({
                url: url + "/help-desk-category/update/" + handleEdit,
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
    ...
    var handleSubmitForm = function () {
        $("#form-add-category").submit(function (e) {
            ...
            let formData = new FormData(form[0]);
            $.ajax({
                url: url + "/help-desk-category/save",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
